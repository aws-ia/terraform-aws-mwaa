...
| <a name="input_secret_prefix"></a> [secret\_prefix](#input\_secret\_prefix) | Optional) The prefix for the Secret Manager secrets MWAA can have access to | `string` | `"NoneThisPrefixDoesNotExist1521662733/*"` | no |
